...
Moran I statistic is 0.3007. Based on simulation, the pseudo p-value is 0.001. This pseudo p-value is calculated based on the (Num of simulated Moran's I values more extreme than our observed statistic + 1) / (Num of total simulations + 1). The low pseudo p-value of 0.001 means that that is a 0.1% probability that we will get a simulation results more extreme than our observed statistic, in other words, there is a 0.1% probability that we would be wrong in rejecting the null hypothesis. We have sufficient evidence that Moran I statistic is less than or equal ro 0.3007.
...
Geary C statistic is 0.6907. Based on simulation, the pseudo p-value is 0.001, which is less than alpha 0.05. We thus have sufficient evidence that Geary C statistic is less than or equal to 0.6907.
